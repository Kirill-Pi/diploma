...
class DetailsLaunch  : Fragment() {
    private lateinit var binding: FragmentDetailLaunchBinding
    lateinit var launch: Launch
    private val viewModel by lazy {
        ViewModelProvider.NewInstanceFactory().create(DetailLaunchFragmentViewModel::class.java)
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentDetailLaunchBinding.inflate(inflater, container, false)
        val view = binding.root
        launch = arguments?.get("launch") as Launch
        return view
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.detailsFab.setOnClickListener {
            ...
            intent.putExtra(
                Intent.EXTRA_TEXT,
                "Check out this Launch: ${launch.name} \n\n ${launch.missionDescription}"
            )
    ...
    private fun detailsInit() {
        binding.detailsToolbar.title = launch.name
        Glide.with(this)
            .load( launch.image)
            .centerCrop()
            .into(binding.detailsPoster)
        binding.annotation = launch.rocket
        binding.dateText.text = launch.net
        binding.rocketText.text = launch.rocketFullName
        binding.countryText.text = launch.agenciesCountry
    ...
    private fun saveToGallery(bitmap: Bitmap) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            val contentValues = ContentValues().apply {
                ...
                put(MediaStore.Images.Media.TITLE, launch.name)
                put(
...
//            }
        ...
        MainScope().launch {
            ...
            val job = scope.async {
                println(launch.image!!)
                viewModel.loadWallpaper( launch.image!!)
